...
namespace Day_2
{
    class ArraysEg
    {
        ...
        public void TwoDimension()
        {
            ...
            //for(int i= 0;i<2;i++) we cannot hard code any part of our application
        ...
        public static JaggedArray()
        {
            ...
            int[][] myjagg = new int[2][]; // only no. of rows is specified, byt col 
            ...
            //to display the element of the above jagged array, we need 2 loops
            for (int i = 0;i <jag2.Length;i++)
            {
                Console.WriteLine("Number of elements at Row :" + i + "are" + " " + jag2[i].lenght
